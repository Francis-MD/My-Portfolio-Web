...
const Contact = () => {
  return (
    <div id='contact' className='w-full lg:h-screen p-2 py-16'>
      <div className='max-w-[1240px] m-auto mt-8 w-full h-full'>
        ...
        <div className='grid lg:grid-cols-6 gap-8'>
          ...
          <div className='col-span-3 lg:col-span-2 w-full h-full shadow-xl shadow-gray-400 rounded-xl p-4'>
            <div className='lg:p-4 h-full '>
              ...
              <div>
                <h2 className='py-2'>Francis MD</h2>
              ...
              <div>
              <p className='uppercase pt-6 '>Contact
                  me and let&apos;s talk.</p>
                <p className='pt-2 pb-6 font-semibold'>hifrancismd@gmail.com</p>
